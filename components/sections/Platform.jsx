...
const signals = [
  { pair: "EURUSD",  action: "BUY",  color: "#4ADE80", price: "1.08540", status: "Active",     time: "2m ago" },
  { pair: "XAUUSD",  action: "WAIT", color: "#FACC15", price: "2,345.60", status: "Monitoring", time: "15m ago" },
  { pair: "BTCUSDT", action: "SELL", color: "#F87171", price: "64,320.00", status: "Closed",    time: "1h ago" },
];
...
/*
 * ── Shared card style tokens (used inside dashboard) ────────
 *
 * Padding:  p-3.5     (14px — uniform)
 * Radius:   rounded-xl (12px — uniform)
 * Bg:       bg-yfx-card/50
 * Border:   border border-border-subtle
 * Label:    text-[10px] text-text-muted
 * Gap:      gap-2.5   (10px — uniform between all card rows)
 */
          ...
          <ScrollReveal delay={0.15}>
            ...
            >
              ...
              <div className="flex min-h-[440px] sm:min-h-[500px]">
                ...
                {/* Sidebar */}
                <aside className="hidden sm:flex flex-col w-[140px] lg:w-[156px] border-r border-border-subtle py-5 px-3 shrink-0">
                ...
                {/* ── Main content ─────────────────────────────── */}
                <div className="flex-1 p-3.5 sm:p-4 lg:p-5 overflow-hidden flex flex-col gap-2.5">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
                    ...
                    <div className={card}>
                      ...
                      <span className="block text-[15px] sm:text-base font-semibold text-text-primary font-mono leading-none">
                        $127,540
                      </span>
                      <span className="inline-block mt-2 text-[9px] font-mono font-medium leading-none px-1.5 py-[3px] rounded-md bg-[#4ADE80]/10 text-[#4ADE80]">
                        +3.28%
                      </span>
                    </div>
                    ...
                    <div className={card}>
                      ...
                      <span className="block mt-2 text-[9px] text-text-muted leading-none">
                        Active
                      </span>
                    </div>
                    ...
                    <div className={card}>
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[15px] sm:text-base font-semibold text-[#4ADE80] leading-none">Running</span>
                      </div>
                      <span className="block mt-2 text-[9px] text-text-muted leading-none">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-[1fr_176px] gap-2.5">
                    ...
                    <div className={card}>
                      <div className="flex items-center justify-between mb-4">
                        <span className="text-[10px] sm:text-xs text-text-secondary font-medium">Equity Curve</span>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5">
                    ...
                    {/* Recent Signals */}
                    <div className={card}>
                      <span className="block text-[10px] sm:text-xs text-text-secondary font-medium mb-3">Recent Signals</span>
                      <div className="flex flex-col gap-2">
                        {signals.map((s,i) => (
                          <div key={i} className="flex items-center text-[9px] sm:text-[10px]">
                            ...
                            <span className="text-text-muted hidden sm:block w-[60px] shrink-0">{s.status}</span>
                    ...
                    {/* Market Snapshot */}
                    <div className={card}>
                      <span className="block text-[10px] sm:text-xs text-text-secondary font-medium mb-3">Market Snapshot</span>
                      <div className="flex items-start gap-4">
                        <svg width="56" height="56" viewBox="0 0 60 60" className="shrink-0 hidden sm:block">
